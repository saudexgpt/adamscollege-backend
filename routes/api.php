...
Route::get('account/fee-settings/registration-fee', [FeesController::class, 'registrationFee']);
...
Route::group(['middleware' => 'auth:sanctum'], function () {
    ...
    Route::group(['prefix' => 'account'], function () {
        Route::group(['prefix' => 'fee-settings'], function () {
            ...
            Route::post('apply/specific-student-school-fee', [FeesController::class, 'applySpecificStudentSchoolFees']);
            

            Route::post('save-paystack-key', [FeesController::class, 'savePaystackKey']);
            Route::post('save-registration-fee', [FeesController::class, 'saveRegistrationFee']);
        ...
        Route::group(['prefix' => 'fee-payments'], function () {
            ...
            Route::post('pay-via-card-for-registration', [PaymentsController::class, 'payViaCardForRegistration']);
            ...
            Route::get('fetch-registration-fee-payments', [PaymentsController::class, 'fetchRegistrationFeePayments']);
